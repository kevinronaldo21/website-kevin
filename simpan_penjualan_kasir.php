    ...
    <blockquote>
      ...
      <table border="1">
        <tr bgcolor="#00FFFF">
          ...
          <td><div align="center"><span class="style26">Tgl Penjualan</span></div></td>
        ...
        <?php do { ?>
          <tr bgcolor="#FFFFFF">
            <td><div align="center"><span class="style26 style1"><?php echo $row_Recordset1['id']; ?></span></div></td>
            <td><div align="center"><span class="style26 style1"><?php echo $row_Recordset1['no_penjualan']; ?></span></div></td>
            <td><span class="style26 style1"><?php echo $row_Recordset1['nama_kasir']; ?></span></td>
            <td><span class="style26 style1"><?php echo $row_Recordset1['tgl_penjualan']; ?></span></td>
            <td><div align="center"><span class="style26 style1"><?php echo $row_Recordset1['jam_penjualan']; ?></span></div></td>
            <td><span class="style26 style1"><?php echo $row_Recordset1['total']; ?></span></td>
            <td><a href="edit_penjualan.php?id=<?php echo $row_Recordset1['id']; ?>" class="style26 style1"><img src="images/imgbin-computer-icons-editing-font-awesome-graphics-editor-advertising-GasA3YjEDg9X1DbvZwBNj5JYC.png" width="16" height="17" border="0" /></a></td>
            <td><a href="hapus_penjualan.php?id=<?php echo $row_Recordset1['id']; ?>" class="style26 style1"><img src="images/pngtree-delete-button-3d-icon-png-image_8633077.png" width="17" height="21" border="0" /></a></td>
          </tr>
