...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO unit (id_unit, satuan) VALUES (%s, %s)",
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center" bordercolor="#000000" bgcolor="#E3DAB1">
          <tr valign="baseline">
            ...
            <td><input type="text" name="id_unit" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Satuan:</span></td>
            <td><input type="text" name="satuan" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
