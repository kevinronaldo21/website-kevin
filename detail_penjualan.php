      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><label></label>
            <input name="no_penjualan" type="text" id="no_penjualan" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="jumlah_barang" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="sub_total" value="" size="32"></td>
          </tr>
