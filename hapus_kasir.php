...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE kasir SET kode_kasir=%s, nama_kasir=%s, username_kasir=%s, password_kasir=%s WHERE id=%s",
                       GetSQLValueString($_POST['kode_kasir'], "text"),
                       GetSQLValueString($_POST['nama_kasir'], "text"),
                       GetSQLValueString($_POST['username_kasir'], "text"),
                       GetSQLValueString($_POST['password_kasir'], "text"),
                       GetSQLValueString($_POST['id'], "int"));

  mysql_select_db($database_apotek, $apotek);
  $Result1 = mysql_query($updateSQL, $apotek) or die(mysql_error());

  $updateGoTo = "kasir.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM kasir WHERE id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_apotek, $apotek);
  $Result1 = mysql_query($deleteSQL, $apotek) or die(mysql_error());

  $deleteGoTo = "kasir.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_apotek, $apotek);
$query_Recordset1 = sprintf("SELECT * FROM kasir WHERE id = %s", $colname_Recordset1);
...
<div id="container">
  ...
  <div id="content">
    <blockquote>
      <h2 align="center" class="byline style1">INPUT DATA KASIR </h2>
      <p align="left" class="byline style1">&nbsp;</p>
        ...
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Kode kasir:</span></td>
            <td><input type="text" name="kode_kasir" value="<?php echo $row_Recordset1['kode_kasir']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Nama kasir:</span></td>
            <td><input type="text" name="nama_kasir" value="<?php echo $row_Recordset1['nama_kasir']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Username kasir:</span></td>
            <td><input type="text" name="username_kasir" value="<?php echo $row_Recordset1['username_kasir']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Password kasir:</span></td>
            <td><input type="text" name="password_kasir" value="<?php echo $row_Recordset1['password_kasir']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
