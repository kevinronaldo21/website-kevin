...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE unit SET satuan=%s WHERE id_unit=%s",
...
if (isset($_GET['id_unit'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['id_unit'] : addslashes($_GET['id_unit']);
}
mysql_select_db($database_apotek, $apotek);
$query_Recordset1 = sprintf("SELECT * FROM unit WHERE id_unit = %s", $colname_Recordset1);
  ...
  <div id="content">
    <blockquote>
      ...
      <p align="left" class="byline style1">&nbsp;</p>
        ...
        <table align="center" bordercolor="#000000" bgcolor="#E3DAB1">
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Id unit:</span></td>
            <td><input type="text" name="id_unit" value="<?php echo $row_Recordset1['id_unit']; ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right"><span class="style1">Satuan:</span></td>
