...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO penjualan (id, no_penjualan, nama_kasir, tgl_penjualan, jam_penjualan, total) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "simpan_penjualan.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <div id="content">
    <blockquote>
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table height="244" align="center">
          <tr valign="baseline">
            <td width="92" height="32" align="right" nowrap bgcolor="#00FFFF"><div align="left" class="style1">
              <div align="right">Id</div>
            </div></td>
            <td width="272"><input type="text" name="id" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#00FFFF"><div align="left" class="style1">
              <div align="right">No Penjualan</div>
            </div></td>
            <td><input type="text" name="no_penjualan" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="30" align="right" nowrap bgcolor="#00FFFF"><div align="left" class="style1">
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#00FFFF"><div align="left" class="style1">
              <div align="right">Tanggal penjualan</div>
            </div></td>
            <td><input type="text" name="tgl_penjualan" value="" size="32" />
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="jam_penjualan" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="30" align="right" nowrap bgcolor="#00FFFF"><div align="left" class="style1">
          ...
          <tr valign="baseline">
            <td height="44" colspan="2" align="right" nowrap bgcolor="#00FFFF">
