...
<div id="container">
  ...
  <div id="content">
    <blockquote>
      <h2 align="center" class="byline style1">LAPORAN TAHUNAN </h2>
      <p align="left"><a href="lap_tahunan.php"><img src="images/icon-quality-png-file-png-file-png-file-png-file-31.png" width="22" height="20" /><strong>TAMBAH LAPORAN TAHUNAN </strong></a></p>
      <table border="0">
        <tr bgcolor="#00FFFF">
          ...
          <td rowspan="2"><p class="style1">&nbsp;</p>
          <p class="style1">Keuntungan</p></td>
        </tr>
        <tr bgcolor="#00FFFF">
          <td><div align="center" class="style27">
        ...
        <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
	  	 ...
	  	 <p>&nbsp;</p>
		<div align="center"><input class="noPrint" type="button" value="PRINT LAPORAN" onclick="window.print()"
	  	</div>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
