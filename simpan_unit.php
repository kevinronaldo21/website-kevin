...
$query_Recordset1 = "SELECT * FROM unit";
...
<div id="container">
  ...
  <div id="content">
    <blockquote>
      ...
      <p align="left" class="byline style1"><a href="unit.php"><img src="images/icon-quality-png-file-png-file-png-file-png-file-31.png" width="22" height="20" /><strong>TAMBAH DATA</strong></a>      </p>
      
      
      <table border="0">
        <tr bgcolor="#00FFFF">
          <td><div align="center" class="style1">id unit</div></td>
          <td><div align="center"><span class="style1">satuan</span></div></td>
          <td colspan="2" bgcolor="#33FFFF"><div align="center" class="style1">Operasi</div></td>
        </tr>
        <?php do { ?>
          <tr bordercolor="#000000" bgcolor="#FFFFFF">
            <td><div align="center"><span class="style1"><?php echo $row_Recordset1['id_unit']; ?></span></div></td>
            <td><span class="style1"><?php echo $row_Recordset1['satuan']; ?></span></td>
            <td><a href="edit_unit.php?id_unit=<?php echo $row_Recordset1['id_unit']; ?>" class="style1"><img src="images/imgbin-computer-icons-editing-font-awesome-graphics-editor-advertising-GasA3YjEDg9X1DbvZwBNj5JYC.png" width="16" height="17" border="0" /></a></td>
            <td><a href="hapus_unit.php?id_unit=<?php echo $row_Recordset1['id_unit']; ?>" class="style1"><img src="images/pngtree-delete-button-3d-icon-png-image_8633077.png" width="17" height="21" border="0" /></a></td>
          </tr>
