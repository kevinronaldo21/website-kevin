    ...
    <blockquote>
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
        <table width="301" border="0" align="center">
          <tr valign="baseline">
            <td height="28" align="right" nowrap bgcolor="#00FFFF"><div align="right"><span class="style1">Id:</span></div>              </td>
            <td><label>
          ...
          <tr valign="baseline">
            ...
            <td width="195"><input type="text" name="kode_barang" value="<?php echo $row_Recordset1['kode_barang']; ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><label>
              <select name="penyimpanan" id="penyimpanan" title="<?php echo $row_Recordset1['penyimpanan']; ?>">
          ...
          <tr valign="baseline">
            ...
            <td><label>
              <select name="nama_kategori" id="nama_kategori" title="<?php echo $row_Recordset1['nama_kategori']; ?>">
                <option value="--Silakan Pilih--">--Silakan Pilih--</option>
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="kadaluarsa" value="<?php echo $row_Recordset1['kadaluarsa']; ?>" size="32" />
