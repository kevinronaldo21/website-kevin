...
.style6 {color: #000000; font-size: 14; }
    ...
    <tr>
      <th bgcolor="#FFFF99" scope="col"><div align="center">
        ...
        <table width="903" border="0" align="center">
          <tr>
            <td width="619" class="style3"><div align="center"><a href="simpan_detail_penjualan.php" class="style7"> <img src="images/back_icon-icons.com_65134.png" width="24" height="26" />Kembali</a></div></td>
            <td width="386" class="style6"><a href="print_laporan_detail.php"><img src="Apotek/Images/Untitled.png" width="34" height="29" />Print Laporan </a></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <table border="1">
