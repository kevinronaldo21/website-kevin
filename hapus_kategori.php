...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE kategori SET nama_kategori=%s, des_kategori=%s WHERE id_kategori=%s",
  ...
  $updateGoTo = "simpan_kategori.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_GET['id_kategori'])) && ($_GET['id_kategori'] != "")) {
  ...
  $deleteGoTo = "simpan_kategori.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['id_kategori'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['id_kategori'] : addslashes($_GET['id_kategori']);
}
mysql_select_db($database_apotek, $apotek);
$query_Recordset1 = sprintf("SELECT * FROM kategori WHERE id_kategori = %s", $colname_Recordset1);
  ...
  <div id="content">
    <blockquote>
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1">
        <table align="center">
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#00FFFF"><span class="style1">Id Kategori:</span></td>
            <td><input type="text" name="id_kategori" value="<?php echo $row_Recordset1['id_kategori']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#00FFFF"><span class="style1">Nama Kategori:</span></td>
            <td><input type="text" name="nama_kategori" value="<?php echo $row_Recordset1['nama_kategori']; ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="29" align="right" nowrap bgcolor="#00FFFF"><span class="style1">Des Kategori:</span></td>
            <td><input type="text" name="des_kategori" value="<?php echo $row_Recordset1['des_kategori']; ?>" size="32"></td>
          </tr>
