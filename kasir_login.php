...
<div id="container">
  ...
  <div id="menuh-container">
    <div id="menuh">
      <ul>
        <li>
          <div align="center"><a href="simpan_barang_kasir.php" class="top_parent"><strong>DATA BARANG</strong></a></div>
        </li>
      </ul>
      <ul>
        <li>
          <div align="center"><a href="simpan_penjualan_kasir.php" class="top_parent"><strong>DATA PENJUALAN</strong></a></div>
        </li>
      </ul>
	  <ul>
  ...
  <div id="leftnav">
    ...
    <p align="left" class="style1 quote"><strong><a href="simpan_barang.php"><img src="Apotek/Images/2426188-200.png" width="20" height="19" /></a><a href="lap_bulanan.php"><strong> LAPORAN BULANAN</strong> </a></strong></p>
    <p align="left" class="quote style1"><strong><a href="simpan_barang.php"><img src="Apotek/Images/2426188-200.png" width="20" height="19" /></a><a href="Lap_tahunan.php"><strong>LAPORAN TAHUNAN </strong> </a></strong></p>
  ...
  <div id="content">
    <blockquote>
      <h2 align="center" class="byline style1">SELAMAT DATANG PETUGAS KASIR </h2>
      <p align="center">&nbsp;</p>
