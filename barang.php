    ...
    <blockquote>
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table width="301" border="0" align="center">
          <tr valign="baseline">
            <td height="28" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Id:</span></div>              </td>
            <td><label>
              <input name="id" type="text" id="id" />
            </label></td>
          </tr>
          <tr valign="baseline">
            <td width="96" height="28" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Kode Barang:</span></div></td>
            <td width="195"><input type="text" name="kode_barang" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td height="29" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Nama Barang:</span></div></td>
            <td><input type="text" name="nama_barang" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Penyimpanan:</span></div></td>
            <td><label>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Stok:</span></div></td>
            <td><input type="text" name="stok" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="33" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Satuan:</span></div></td>
            <td><label>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Nama Kategori:</span></div></td>
            <td><label>
              <select name="nama_kategori" id="nama_kategori">
                ...
                <option value="Obat erbal (jamu)">Obat erbal (jamu)</option>
                <option value="Obat Bebas">Obat Bebas</option>
              </select>
            </label></td>
          </tr>
          <tr valign="baseline">
            <td height="36" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Kadaluarsa:</span></div></td>
          ...
          <tr valign="baseline">
            <td height="31" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Harga Beli:</span></div></td>
            <td><input type="text" name="harga_beli" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="26" align="right" nowrap bgcolor="#FF0000"><div align="right"><span class="style1">Harga Jual:</span></div></td>
            <td><input type="text" name="harga_jual" value="" size="32"></td>
          </tr>
          <tr valign="baseline" bgcolor="#FF0000">
            <td height="30" colspan="2" align="right" nowrap>
